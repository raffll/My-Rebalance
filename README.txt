## Intentions
My intention here is not to balance the game. It's impossible. Neither make it harder or easier. Reason behind this is to make more options useful, for fun of playing more specialized characters.
...
sMagicInsufficientCharge							Annoing message is removed.
fMagicItemRechargePerSecond		0.05 -> 0			Idle recharging is disabled, because this change alone make Enchant useful skill.
...
## Magic -- Lots of spell effects wasn't really useful because of better alternatives. Also it's worth trying now elemental shield for fun of killing low level creatures.

fElementalShieldMult			0.1 -> 1			1 point of damage for 1 point of magnitude.
Demoralize Humanoid				Mysticism -> Illusion
SlowFall -> Slowfall

-- ALTERATION -- Those weren't useful previously.
...
-- DESTRUCTION -- TODO: Do elemental damage uniform cost of 5.
Poison							9 -> 4
...
-- MYSTICISM -- Absorb spells were overpowered.
Absorb Health					8 -> 13				Damage Health (8) + Restore Health (5).
Absorb Fatigue					4 -> 5				Damage Fatigue (4) + Restore Fatigue (1).

-- RESTORATION
Fortify Magicka					1 -> 0.75			25% cheaper than Fortify Intelligence (1).
Fortify Skill					1 -> 4				4x more expensive, because it's overpowered.

## Locks & Traps -- Those changes makes Security skill useful again on higher levels. Previously magic was a better option to unlock the door at any level. Also trap mechanics was disabled and everyone can untrap too easy.
...
-- SPELL EFFECT
Open							6  -> 12			2x more expensive to make open spells worse option than Security.
													Keep in mind that self made spells are another 2x more expensive than standalones.

-- COST
trap_poison00					16 -> 36			New trap spell costs calculated from new spell effect values.
trap_fire00						3  -> 8
trap_health00					8  -> 13
trap_frost00					3  -> 10
...
-- PRICE
sc_ondusisunhinging_en			73 -> 273			It was too cheap and widely available.
